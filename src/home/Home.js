        ...
        <div className="home">
            <div className="home_container">
                ...
                <div className="home_row">
                    <Product id="31102021-1" title="The Lean Startup: How Today's Entrepreneurs Use Continuous Innovation to Create..." price={1966.00} rating={4} image="https://images-eu.ssl-images-amazon.com/images/I/51T-sMqSMiL._SY264_BO1,204,203,200_QL40_FMwebp_.jpg" />
                    <Product id="31102021-2" title="eufy by Anker, RoboVac X8 Hybrid, Robot Vacuum and Mop Cleaner with iPath Laser Navigation, Twin..." price={31999.00} rating={5} image="https://m.media-amazon.com/images/I/713rjcYi9dL._SX425_.jpg" />
                </div>
                <div className="home_row">
                    ...
                    <Product id="31102021-3" title="RE Enterprise Women's Latest Black Embroidery Maxi..." price={1199.00} rating={4} image="https://m.media-amazon.com/images/I/6142tbfHTDL._UX466_.jpg" />
